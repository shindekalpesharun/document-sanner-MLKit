package com.shindekalpesharun.documentscannermlkit
...
import com.shindekalpesharun.documentscannermlkit.ui.theme.DocumentScannerMLKitTheme
import java.io.File
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val options = GmsDocumentScannerOptions.Builder().setScannerMode(SCANNER_MODE_FULL)
            .setGalleryImportAllowed(true).setPageLimit(100)
            .setResultFormats(RESULT_FORMAT_PDF, RESULT_FORMAT_JPEG).build()
